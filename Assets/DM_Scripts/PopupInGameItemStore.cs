...
public class PopupInGameItemStore : Popup
{
	...
	public void SetPopup(Booster.BoosterType boosterType, bool isTutorial = false)
	{
		...
		case Booster.BoosterType.Hammer:
			...
			TextDesc.text = "Magic Hammer can break a Musical Notes or an obstacle.";
			break;
		case Booster.BoosterType.CandyPack:
			TextTitle.text = "Creatures Bomb";
			TextDesc.text = "You can remove all of the Musical Notes and obstacles.";
			break;
		case Booster.BoosterType.HBomb:
			TextTitle.text = "Horizontal Rocket";
			TextDesc.text = "You can removes any Musical Notes that are either horizontally.";
			break;
		case Booster.BoosterType.VBomb:
			TextTitle.text = "Vertical Rocket";
			TextDesc.text = "You can removes any Musical Notes that are either vertically.";
			break;
		}
		listItems.Clear();
