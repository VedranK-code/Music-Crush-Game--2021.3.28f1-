...
/////////////////////////////////////////////////////////////////////
    public float timeLim = 15f; // Total time limit in seconds
    ...
    public TextMeshProUGUI highScoreText; // TextMeshProUGUI for high score display
    ...
    private void Start()
    {
       ...
       ////////////////////////////////////////////////////////////////////
        ...
        //StartCoroutine(HideTextForDuration(4f));
        timerPaused=true;
        ...
        // Update the high score TextMeshProUGUI component
...
private System.Collections.IEnumerator HideTextForDuration(float duration)
    {
        // Hide the TextMeshPro object by disabling its component
        textToHide.enabled = false;

        // Wait for the specified duration
        yield return new WaitForSeconds(duration);

        // Show the TextMeshPro object by enabling its component
...
private void Update()
    {
        ...
        {
            // Timer has reached zero, handle the end of the timer
            TimerEnd();
        ...
        else
        {
            // Timer has reached zero, handle the end of the timer
            TimerEnd();
            RotateAllCubes(sideRotations[2].eulerAngles, rotationSpeed);
...
private void WinScreen(Vector3 targetEulerAngles, float speed)
 ...
 private void UpdateTimerText()
    {
        // Update the TextMeshProUGUI component to display the current time remaining without decimals
    ...
    {
        // Handle the end of the timer, such as game over or other actions
        ...
        if (score == 0) // Check if the game was lost
    {
        ...
        // Update the score TextMeshProUGUI component
        highScoreText.text = "Score: " + score.ToString();
    }
}